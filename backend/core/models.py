...
class BusinessProfile(models.Model):
    ...
    default_capacity_wash = models.PositiveIntegerField(default=settings.DEFAULT_DAILY_CAPACITY)
    default_capacity_detailing = models.PositiveIntegerField(default=settings.DEFAULT_DAILY_CAPACITY)
