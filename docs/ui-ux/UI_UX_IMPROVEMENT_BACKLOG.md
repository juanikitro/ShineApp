...
| --- | --- | --- | --- | --- | --- | --- |
| 1 | UI-009 | P1/P2 | Arquitectura frontend | Continuar extraccion por vertical de `frontend/app/page.tsx` sin mezclar redisenos. | Cortes aplicados: Caja en `components/cash/CashPanel.tsx` y Deudas en `components/debts/DebtPanel.tsx`; `page.tsx` sigue grande con 17.232 lineas y aprox. 161 `render*`. | Menos riesgo de regresion y cambios UI mas faciles de validar. |
...
| UI-009 | Caja + Deudas / arquitectura frontend | Parcialmente reducido: renders de Caja y Deudas extraidos a `CashPanel.tsx` y `DebtPanel.tsx`; estado, callbacks, payloads y reglas siguen en `page.tsx`. |
...
| --- | --- | --- | --- |
| UI-009 | P1/P2 | Arquitectura frontend | Cortes aplicados en Caja y Deudas; quedan otras verticales, estado, formularios y calculos todavia concentrados en `page.tsx`. |
