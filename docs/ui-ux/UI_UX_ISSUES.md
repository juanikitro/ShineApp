...
| --- | --- | --- | --- | --- | --- |
| UI-009 | P1/P2 | App shell / frontend | Reducido parcialmente: Caja y Deudas ya no viven como bloques JSX dentro de `frontend/app/page.tsx`, pero el archivo sigue concentrando estado, calculo, formularios y renders de otras verticales. | Conteo post-Deudas: `frontend/app/page.tsx` tiene 17.232 lineas y aprox. 161 coincidencias `render*`; `CashPanel.tsx` suma 675 lineas y `DebtPanel.tsx` 450 lineas presentacionales. | Continuar extraccion por vertical sin redisenar: settings, dashboard, inventario o formularios segun el siguiente cambio funcional. |
