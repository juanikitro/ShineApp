...
| --- | --- | --- | --- | --- | --- |
| UI-009 | P1/P2 | App shell / frontend | Reducido parcialmente: Caja, Deudas y Dashboard ya no viven como bloques JSX dentro de `frontend/app/page.tsx`, pero el archivo sigue concentrando estado, formularios y renders de otras verticales. | Conteo post-Dashboard: `frontend/app/page.tsx` tiene 16.929 lineas y aprox. 161 coincidencias `render*`; `CashPanel.tsx` suma 675 lineas, `DebtPanel.tsx` 450 y `DashboardPanel.tsx` 906 lineas presentacionales. | Continuar extraccion por vertical sin redisenar: settings, inventario o formularios segun el siguiente cambio funcional. |
